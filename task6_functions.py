...
print("Total Sales For First Game:", calculate_total_sales(video_game_sales[0]))
...
print("Filtered with default ('Platform'):", filter_by_genre(video_game_sales))
print("Filtered with 'Shooter':", filter_by_genre(video_game_sales, 'Shooter'))
